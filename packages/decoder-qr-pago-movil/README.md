...
> En Banco de Venezuela (`0102`), el campo `name` se muestra como Concepto. El comportamiento puede variar entre bancos.
...
> En Banco de Venezuela (`0102`), usa `name` para completar el Concepto. El comportamiento puede variar entre bancos.
> El campo `description` no es aceptado por todos los bancos. Verifica con tu entidad antes de usarlo.
